        ...
        return (
            <Fragment>
                <Container className="text-center" fluid={true}>
                    <div className="section-title text-center mb-55"><h2> Sepete Eklenen Ürünler</h2>
                        <p>Özel Koleksiyonlarımızdan Bazıları, Beğenebilirsiniz</p>
                    </div>
                    ...
                    <Row>
                        <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <Card className="image-box card w-100">
                                ...
                                <Card.Body>
                                    <p className="product-name-on-card">Çizgili Erkek Kırmızı Kapşonlı</p>
                                    <p className="product-price-on-card">Fiyat : 120₺</p>
                                    <Button className="btn btn-sm"> <i className="fa fa-trash-alt"></i> Kaldır </Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        ...
                        <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <Card className="image-box card w-100">
                                ...
                                <Card.Body>
                                    <p className="product-name-on-card">Çizgili Erkek Yuvarlak Yaka, Bordo-Gri</p>
                                    <p className="product-price-on-card">Fiyat : 120₺</p>
                                    <Button className="btn btn-sm"> <i className="fa fa-trash-alt"></i> Kaldır </Button>
                        ...
                        <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <Card className="image-box card w-100">
                                ...
                                <Card.Body>
                                    <p className="product-name-on-card">Siyah Renk Çizgili Erkek</p>
                                    <p className="product-price-on-card">Fiyat : 120₺</p>
                                    <Button className="btn btn-sm"> <i className="fa fa-trash-alt"></i> Kaldır </Button>
                        ...
                        <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <Card className="image-box card w-100">
                                ...
                                <Card.Body>
                                    <p className="product-name-on-card">Baskılı Erkek Kırmızı T-Shirt</p>
                                    <p className="product-price-on-card">Fiyat : 120₺</p>
                                    <Button className="btn btn-sm"> <i className="fa fa-trash-alt"></i> Kaldır </Button>
