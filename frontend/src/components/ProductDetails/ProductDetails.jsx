                        ...
                        <Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
                            <Row>
                                ...
                                <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
                                    ...
                                    <h6 className="section-sub-title">Özel Koleksiyonlarımızdan Bazıları, Bunları Da
                                    Beğenebilirsiniz</h6>
                                    <div className="input-group">
                                        <div className="Product-price-card d-inline ">Normal Fiyat 200₺</div>
                                        <div className="Product-price-card d-inline ">50% İndirim</div>
                                        <div className="Product-price-card d-inline ">Yeni Fiyat 100₺</div>
                                    </div>
                                    <h6 className="mt-2">Renk Seçin</h6>
                                    <div className="input-group">
                                    ...
                                    <h6 className="mt-2">Boyut Seçin</h6>
                                    <div className="input-group">
                                        <div className="form-check mx-1">
                                            <input className="form-check-input" type="radio" name="exampleRadios"
                                                   id="exampleRadios1" value="option1"/>
                            ...
                            <Row>
                                <Col className="" md={6} lg={6} sm={12} xs={12}>
                                    <h6 className="mt-2">Ürün Detayları</h6>
