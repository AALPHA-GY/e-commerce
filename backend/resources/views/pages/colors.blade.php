    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul class="colors-list list-unstyled mb-0">
            <li class="d-flex align-items-center py-25">
              <i class="bx bx-chevrons-right"></i><code>.bg-primary .bg-lighten-{1,2,3,4,5}</code>
            </li>
            <li class="d-flex align-items-center py-25">
              <i class="bx bx-chevrons-right"></i><code>.bg-success .bg-lighten-{1,2,3,4,5}</code>
            </li>
            <li class="d-flex align-items-center py-25">
              <i class="bx bx-chevrons-right"></i><code>.bg-danger .bg-lighten-{1,2,3,4,5}</code>
            </li>
            <li class="d-flex align-items-center py-25">
              <i class="bx bx-chevrons-right"></i><code>.bg-warning .bg-lighten-{1,2,3,4,5}</code>
            </li>
            <li class="d-flex align-items-center py-25">
              <i class="bx bx-chevrons-right"></i><code>.bg-info .bg-lighten-{1,2,3,4,5}</code>
            </li>
          </ul>
          <p>For each color, we think has its functionality in the application as alerts of errors <b>(danger)</b>,
            warnings to the user <b>(warning)</b>, communications of approval <b>(success)</b>, or main color of the
            ...
            <div class="d-flex justify-content-start flex-wrap">
              <div
                class="text-center bg-primary bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow">
                <span class="align-middle text-primary">primary</span>
              </div>
              <div
                class="text-center bg-secondary bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow">
                <span class="align-middle text-secondary">secondary</span>
              </div>
              <div
                class="text-center bg-success bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50  my-1 shadow">
                <span class="align-middle text-success">success</span>
              </div>
              <div
                class="text-center bg-danger bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50  my-1 shadow">
                <span class="align-middle text-danger">danger</span>
              </div>
              <div
                class="text-center bg-warning bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50  my-1 shadow">
                <span class="align-middle text-warning">warning</span>
              </div>
              <div
                class="text-center bg-info colors bg-lighten-5 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center my-1 ml-50 shadow">
